...
<div className="col-span-3 md:col-span-2 flex flex-col items-center md:items-start gap-4 pt-16 px-2">
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pb-8 pt-4 mx-auto">
        ...
        <div
            className="flex flex-col justify-center items-center gap-2 border-2 border-dashed border-gray-500/50 p-4 rounded-md h-32 ">
        ...
        <FcSalesPerformance className="text-4xl" />
            ...
            <span className="font-semibold text-sm text-center">Total Sales</span>
        </div>
        ...
        <FaMoneyBillTrendUp className="text-4xl" />
            ...
            <span className="font-semibold text-sm text-center">Total Revenue</span>
        </div>
        ...
        <FcPaid className="text-4xl" />
            ...
            <span className="font-semibold text-sm text-center">Paid Total</span>
        </div>

        <div 
            className="md:col-start-2 lg:col-auto flex flex-col justify-center items-center gap-2 border-2 border-dashed border-gray-500/50 p-4 rounded-md h-32 ">
            <div className="flex gap-2 items-center">
                <span className="font-bold text-3xl md:text-4xl">
            3.3k
        </span>
        <MdOutlinePendingActions className="text-4xl" />
            ...
            <span className="font-semibold text-sm text-center">Pending Total</span>
        </div>
