...
import { TbCreditCardPay, TbFolderQuestion } from "react-icons/tb";
          ...
          <div className={`bg-[#3b3939] text-white w-full pt-14 md:w-1/5 z-10 ${isNavOpen ? 'absolute' : 'hidden'} md:block`}>
            <div className="p-6 ">
              ...
              <ul className="mt-4 pb-10 ">
               ...
               <NavLink to="/seller/home" > <li className=" flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
               <svg className="mr-1"  height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg>Seller Home </li></NavLink>
  
              <NavLink to="/seller/manage-medicine"><li className="flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
              <GiMedicinePills className="mr-2 text-xl" />
                Manage Medicines</li></NavLink> 

              <NavLink to="/seller/payment-history"><li className="flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
              <TbCreditCardPay className="mr-2 text-xl" />
              Payment History</li></NavLink> 

              <NavLink to="/seller/ask-add"><li className="flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
              <TbFolderQuestion className="mr-2 text-xl" />
              Ask For Advertisement</li></NavLink> 
