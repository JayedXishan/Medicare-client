    ...
    return (
        <>
         ...
         <div className="relative flex h-screen min-w-full ">
          ...
          {/* Navigation */}
          <div className={`bg-[#3b3939] text-white w-full pt-14 md:w-1/5 z-10 ${isNavOpen ? 'absolute' : 'hidden'} md:block`}>
            <div className="p-6 ">
              <h1 className="text-xl font-bold">Admin</h1>
  
              <ul className="mt-4 pb-10 ">
                
               <NavLink to="/admin/home" > <li className=" flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
               <svg className="mr-1"  height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg>Amin Home </li></NavLink>
  
              <NavLink to="/admin/manage-users"><li className="flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
              <HiMiniUsers className="mr-2 text-xl" />
                Manage Users</li></NavLink> 
  
              <NavLink to="/admin/manage-category"><li className="flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
              <TbCategory  className="mr-2 text-xl"/>
              Manage Category </li></NavLink> 

              <NavLink to="/admin/payment-manage"><li className="flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
              <MdPayments  className="mr-2 text-xl"/>
              Payment management </li></NavLink> 

              <NavLink to="/admin/sales-report"><li className="flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
              <TbReportMoney  className="mr-2 text-xl"/>
              Sales Report </li></NavLink> 

              <NavLink to="/admin/manage-banner"><li className="flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
              <MdManageHistory  className="mr-2 text-xl"/>
              Manage banner Add </li></NavLink> 
             ...
             <button > <li className="absolute bottom-0 mb-10 flex items-center py-2 transition duration-300 ease-in-out hover:bg-white hover:text-[#3b3939] font-semibold  px-4 rounded-sm " onClick={closeNav}>
  ...
  <path  d="M4.46967 11.4697C4.17678 11.7626 4.17678 12.2374 4.46967 12.5303L6.46967 14.5303C6.76256 14.8232 7.23744 14.8232 7.53033 14.5303C7.82322 14.2374 7.82322 13.7626 7.53033 13.4697L6.81066 12.75L14 12.75C14.4142 12.75 14.75 12.4142 14.75 12C14.75 11.5858 14.4142 11.25 14 11.25L6.81066 11.25L7.53033 10.5303C7.82322 10.2374 7.82322 9.76256 7.53033 9.46967C7.23744 9.17678 6.76256 9.17678 6.46967 9.46967L4.46967 11.4697Z" fill="#fafafa"/>
          ...
          <div className="w-full md:w-4/5">
            ...
            >
                ...
                />
  </svg>  : <MdSpaceDashboard className="text-slate-600 text-3xl" />}
            </button>
